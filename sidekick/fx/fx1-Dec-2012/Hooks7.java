...
//x                    SwingUtilities.invokeLater(new Runnable() {
	...
	private void displayEventInfoXX(final NativeInputEvent e) {
		/* Note: JNativeHook does *NOT* operate on the event dispatch thread.
		 * Because Swing components must be accessed on the event dispatching
		 * thread, you *MUST* wrap access to Swing components using the
		 * SwingUtilities.invokeLater() or EventQueue.invokeLater() methods.
...
//x         if(e instanceof NativeMouseEvent)
//x         {
//x             SwingUtilities.invokeLater(new Runnable() {
//x                 public void run() {
//x                 
//x                     final Point p = ((NativeMouseEvent) e).getPoint();
//x 
//x                     if(p.x >= m_triggerX) 
//x                     {
//x                         if(m_isTriggerZone == false)
//x                         {
//x //x                             System.out.println("T");
//x //x                         
//x //x                             SwingUtilities.invokeLater(new Runnable() {
//x //x                                 public void run() {
//x                                     System.out.println(e.paramString());
//x                                     System.out.println("T" + p.x + " || " + p.y);
//x                                     m_isTriggerZone = true;
//x //x                                 }
//x //x                             });
//x                         }
//x                     }
//x                     else
//x                     {
//x                         if(m_isTriggerZone == true)
//x                         {
//x                             System.out.println("F" + p.x + " || " + p.y);
//x                         }
//x                         
//x                         m_isTriggerZone = false;
//x                     }
//x                 }
//x             });
//x         }
