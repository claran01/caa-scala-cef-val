...
//0 class CefXmlWriter {
//0     
//0     val doc = <cef />
//0     var cur = doc
//0     var curd = (_,_)
//0 
//0     def add_attr(k: String, v: String): Unit = { println("add_attr", k,v) }
//0     def add_comment(s: String): Unit = { println("add_comment", s) }
//0 
//0     def start_meta(n: String): Unit = { 
//0 //.        cur = <meta name="{n}" />    
//0 //.        doc.append(cur)
//0     }
//0     def end_meta(n: String): Unit = { cur = doc }
//0 
//0     def start_var(n: String): Unit = { 
//0 //.        cur = <var name="{n}" />    
//0 //.        doc.append(cur)
//0     }
//0     def end_var(n: String): Unit = { cur = doc}
//0 
//0     
//0 }
